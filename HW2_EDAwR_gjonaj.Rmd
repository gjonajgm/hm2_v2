...
```{r read_countydata}
 ...
 county_mi_df <- read.csv(file = './data/county_MI.csv')

```

* What does each row represent?

Row 1 - importing the county csv file as the data frame county df
Row 2 - importing the county_MI file as the data frame county_mi_df
